...
GCloudStorageCredentials::GCloudStorageCredentials()
  : GCloudStorageCredentials( safe_getenv( GCLOUD_ACCESS_KEY_ENV ),
                              safe_getenv( GCLOUD_SECRET_KEY_ENV ) )
{}

GCloudStorageCredentials::GCloudStorageCredentials( const string & access_key,
